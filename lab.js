...
let favoriteThings = {
  ...
  movie: "Lord of the Rings (It made me read the books)",
...
const laru = new Cat('Laru', 11, 'Gray')

console.log(laru.name)
...
const neville = new Wizard('Neville', 16, 'You tried to get me but you got got')
...
//Code Here
let phoneOne = new Phone('Apple', 'iPhone', 64, 'black', 999)
let phoneTwo = new Phone('Samsung', 'Note 15', 256, 'gray', 1399)
let phoneThree = new Phone('Sony', 'Erikson 9 5G', 128, 'balck', 899)
/* 
...
//Code Here
const myFirstVehicle = new Vehicle(5, 'green', 120000)
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(2, 'black & white', 1500, 'Tao Tao', true)
/*
...
//Code Here
const myFirstBoat = new Boat(15, 'blue', 4500, 'Jenny', 'Shrimp boat', false)
/*
